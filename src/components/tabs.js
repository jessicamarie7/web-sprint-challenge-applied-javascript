...
const tabsAppender = (selector) => {
  ...
  .then(res => {
    const theData = res.data.topics
    appendData.appendChild(Tabs(theData))
  })
  return appendData
}
